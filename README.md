...
```html
<link rel="stylesheet" href="https://unpkg.com/@uurtech/jdf@0.1.22/dist/jdfjs.css">
<script type="module" src="https://unpkg.com/@uurtech/jdf@0.1.22"></script>
...
| **jdf.js** | `npm install @uurtech/jdf` or `<script src="https://unpkg.com/@uurtech/jdf@0.1.22">` |
