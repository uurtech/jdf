...
```html
<link rel="stylesheet" href="https://unpkg.com/@uurtech/jdf@0.1.24/dist/jdfjs.css">
<script type="module" src="https://unpkg.com/@uurtech/jdf@0.1.24"></script>
...
- Published to npm as [`@uurtech/jdf`](https://www.npmjs.com/package/@uurtech/jdf) — install via `npm install @uurtech/jdf` or load from CDN at `https://unpkg.com/@uurtech/jdf@0.1.24` (always pin a version in production).
